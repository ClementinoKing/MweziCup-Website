...
const SheetContent = React.forwardRef<React.ElementRef<typeof Dialog.Content>, SheetContentProps>(
  ...
  <SheetPortal>
    ...
    >
      {children}
      <Dialog.Close className="absolute right-4 top-4 rounded-full border border-border p-2 text-foreground transition hover:bg-secondary">
        <X className="h-4 w-4" />
