...
<body style="margin:0;padding:0;background:#fde5ea;font-family:Arial,Helvetica,sans-serif;">
  <center style="width:100%;background:#fde5ea;">
  <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="background:#fde5ea;padding:40px 20px;border-collapse:collapse;">
    <tr>
      <td align="center" valign="top" style="text-align:center;">
        <table role="presentation" align="center" width="620" cellspacing="0" cellpadding="0" border="0" style="width:620px;max-width:620px;margin:0 auto;border-collapse:collapse;">
          <tr>
            <td align="center" style="padding-bottom:28px;">
              <img
                src="${logoUrl}"
                alt="Mwezi"
                style="display:block;height:54px;object-fit:contain;margin:0 auto;"
              />
            </td>
          </tr>

          <tr>
            <td style="background:#fff7f9;border-radius:28px;padding:42px 32px;text-align:center;border:1px solid #f8c8d3;box-shadow:0 20px 60px rgba(0,0,0,0.08);">
              ...
              <table role="presentation" width="100%" cellspacing="0" cellpadding="0" border="0" style="margin:0 auto 28px;max-width:470px;background:#fff;border:1px solid #f8c8d3;border-radius:20px;">
                <tr>
              ...
              <table role="presentation" cellspacing="0" cellpadding="0" border="0" align="center">
                <tr>
                  <td align="center" style="border-radius:999px;background:#dc1e3d;box-shadow:0 10px 24px rgba(220,30,61,0.25);">
                    <a
                      href="${loginUrl}"
                      style="display:inline-block;background:#dc1e3d;color:#ffffff;text-decoration:none;padding:15px 36px;border-radius:999px;font-size:16px;font-weight:700;"
                    >
                      Accept Invitation
                    </a>
                  </td>
          ...
          <tr>
            <td style="padding-top:24px;text-align:center;color:#9b7280;font-size:13px;line-height:1.6;">
